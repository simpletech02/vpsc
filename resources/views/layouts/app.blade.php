                        ...
                        <ul class="navbar-nav me-auto">
                            @foreach([
                                ...
                                [
                                    ...
                                    'isActive' => request()->routeIs('admin.plans*')
                                ],
                                [
                                    'label' => 'Companies',
                                    'href' => route('admin.companies'),
                                    'isActive' => request()->routeIs('admin.companies*')
                                ]
                            ] as $page)
                                <li class="nav-item">
                                    <a class="nav-link @if($page['isActive']) active @endif" aria-current="page" href="{{$page['href']}}">
                                        {{$page['label']}}
                                    </a>
                                </li>
                            @endforeach
